...
<div class="container col-12  align-center">
  ...
  <form action="{{ route('intersted.post') }}" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
    ...
    <div class="col-md-6" >   
        <div class="form-group">
          ...
          <input type="text"  class="form-control" id="title" placeholder="Intersted Name" name="title">
