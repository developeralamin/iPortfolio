...
<div class="container col-12  align-center">
  ...
  <form action="{{ route('headning.post') }}" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
    ...
    <div class="col-md-6" >   
        <div class="form-group">
          ...
          <input type="text"  class="form-control" id="title" placeholder="Coupon Name" name="title">
  ...
  <div class="col-md-6" >   
   ...
   <textarea  type="text"  class="form-control" id="sub_subtitle" placeholder="sub subtitle" name="sub_subtitle">
